...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\columnwidth]{registrazione.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.9\columnwidth]{uploadOpera.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.8\columnwidth]{modificaPassword.png}
