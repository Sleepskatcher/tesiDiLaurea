...
\end{itemize}
Di questo framework in particolare ho studiato: Spring Boot, Spring DataRest e Spring Data/JPA. Nelle sezioni successive verranno spiegati questi concetti.
