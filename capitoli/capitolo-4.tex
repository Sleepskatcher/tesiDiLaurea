...
\begin{usecase}{1.1}{Inserimento dei dati per la registrazione}\label{uc1.1}
\usecaseactors{Utente non autenticato.}
...
\begin{usecase}{4}{Logout}\label{uc4}
...
\begin{usecase}{5}{Visualizzazione lista opere}
	\usecaseactors{Utente non autenticato.}
...
\begin{usecase}{5.1}{Inserimento filtro sulla lista opere}
	\usecaseactors{Utente non autenticato.}
...
\begin{usecase}{5.1.1}{Inserimento filtro per categorie sulla lista opere}
	\usecaseactors{Utente non autenticato.}
	\usecasepre{L'utente si trova nella pagina principale e sta visualizzando le opere.}
...
\begin{usecase}{5.2}{Visualizzazione dettaglio opera}
	\usecaseactors{Utente non autenticato.}
...
\begin{usecase}{6}{Visualizzazione pagina personale}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.1}{Modifica dati}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.1.1}{Modifica del nome}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.1.2}{Modifica del cognome}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.1.3}{Modifica della data di nascita}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.1.4}{Modifica del wallet address}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.2}{Inserimento della password}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.3}{Vis. lista opere personali}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.3.1}{Vis. dettaglio opera}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.3.2}{Modifica opera}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e si trova nella pagina personale e sta visualizzando la lista delle sue opere.}
...
\begin{usecase}{6.3.2.1}{Modifica titolo}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.3.2.2}{Modifica descrizione}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.3.2.3}{Modifica categorie}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.3.2.4}{Modifica prezzo}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha modificato questo campo.}
...
\begin{usecase}{6.4}{Upload dell'opera}
	\usecaseactors{Utente autenticato.}
...
\begin{usecase}{6.4.1}{Inserimento del titolo}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha compilato questo campo.}
...
\begin{usecase}{6.4.2}{Inserimento della descrizione}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha compilato questo campo.}
...
\begin{usecase}{6.4.3}{Inserimento del file}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha compilato questo campo.}
...
\begin{usecase}{6.4.4}{Inserimento delle categorie}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha compilato questo campo.}
...
\begin{usecase}{6.4.5}{Inserimento del prezzo}
	\usecaseactors{Utente autenticato.}
	\usecasepre{L'utente è autenticato e non ha compilato questo campo.}
